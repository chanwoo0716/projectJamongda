...
public class BoardControllerImpl implements BoardController {
	...
	public ModelAndView listBoards(@RequestParam(value = "section", required = false) String _section,
	...
	public ModelAndView viewBoard(@RequestParam("board_id") int board_id, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public ModelAndView removeBoard(@RequestParam("board_id") int board_id, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
