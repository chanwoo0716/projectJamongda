...
public class AccommodationControllerImpl implements AccommodationController {
	...
	public ModelAndView addAccommodation(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception {
		...
		*/
	    ...
	    accRoMap.put("accMap", accMap);	//accMap: {acc_name=1, acc_tel=1, acc_type=호텔/리조트, acc_area=1, acc_address=1, acc_info=1, email=guro@shillastay.com}
		...
		accRoMap.put("roImageMap", roImageMap);	//roImageMap={ro_image1=[hwangsungbin.webp, ...], ro_image2=[hwangsungbin3.webp, ...]}
