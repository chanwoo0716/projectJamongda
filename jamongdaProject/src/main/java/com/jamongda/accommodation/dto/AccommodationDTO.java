...
public class AccommodationDTO {
	...
	public String getRejectReanson() {
		return rejectReanson;
	}
	public void setRejectReanson(String rejectReanson) {
		this.rejectReanson = rejectReanson;
	}
